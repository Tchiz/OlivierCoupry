...
function getSerieId()
{
	/* On veut savoir quelle série est sélectionnée */
	var serie1 = 0;
	var serie2 = 0;
	var serie3 = 0;
	// On veut savoir la largeur de chaque série (sachant que chaque largeur contient 3 chiffres)
...
{
	// On réinitialise les icones de pagination au niveau CSS
...
{
	// On regarde combien il y a de pages dans cette série
...
{
	/* On réinitialise les icônes de pagination et on met la bonne icone de pagination en avant */
...
{
	/* 
		On met à jour le CSS des icônes de pagination
		On met à jour les minis
	*/
...
{
	/* On met à jour les icônes de pagination */
